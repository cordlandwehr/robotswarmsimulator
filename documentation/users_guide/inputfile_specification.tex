...
\subsubsection{Variables}
	The main project file contains the variables defined in table \ref{tab:mainvars} and \ref{tab:mainvars2}:\\
...
\clearpage
\begin{sidewaystable}
	\begin{tabular}{|l|p{0.2\textwidth}|p{0.3\textwidth}|p{0.1\textwidth}|}
		\hline
		\textbf{Variable name} & \textbf{Possible Values} & \textbf{Description} & \textbf{Default}\\\hline\hline
...
\paragraph{ONE\_POINT\_FORMATION\_VIEW} \ \\
