...
lua generate_scenario.lua $NAME $DEPTH "adaptive_node_movement_"$NAME".lua" $ONIOS

# start the simulation
../../../../build/src/UserInterfaces/RobotSwarmSimulator --project-file "adaptive_node_movement_"$NAME".swarm" --blind --steps $STEPS --history-length 64
