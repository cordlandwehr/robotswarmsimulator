...
--  plt_handler:write("set ylabel 'value of phi'\n")
  ...
  plt_handler:write("set title \"" .. projectname .. " (seed " .. seed .. ")" .. "\"\n")
  ...
  plt_handler:write("set title \"" .. projectname .. " (seed " .. seed .. ")" .. "\"\n")
  plt_handler:write("set xlabel 'rounds (in 1000)'\n")
  plt_handler:write("plot '" .. file_path_cost:format(projectname,timestamp) .. "' using ($1/1000):2 with lines title 'Cost'" .. "\n")
  plt_handler:close()
