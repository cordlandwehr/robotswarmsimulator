...
int main(int argc, char** argv) {
	...
	generation_options.add_options()
		...
		("rnd-min-distance", po::value<double>()->default_value(1.0), "minimum distance of a random step")
		("rnd-max-distance", po::value<double>()->default_value(25.0), "maximum distance of a random step")
