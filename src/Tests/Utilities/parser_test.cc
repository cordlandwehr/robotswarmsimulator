...
BOOST_AUTO_TEST_CASE(loading_main_project_file_1)
{
	...
	parser->load_projectfiles("src/ProjectFiles/projectfile.swarm");
...
{
	Parser* parser = new Parser();
	parser->load_projectfiles("src/Tests/Testdata/garbled_projectfile_a.swarm");
...
BOOST_AUTO_TEST_CASE(loading_main_project_file_3)
{
	Parser* parser = new Parser();
	parser->load_projectfiles("src/Tests/Testdata/garbled_projectfile_b.swarm");
