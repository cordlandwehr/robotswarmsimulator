...
void LuaWorldModifier::register_lua_methods() {
	...
	luabind::def("add_robot", (void(*)(std::size_t)) &WorldInformationWrapper::add_robot),
	luabind::def("add_robot", (void(*)(std::size_t, MarkerInformationWrapper)) &WorldInformationWrapper::add_robot),
